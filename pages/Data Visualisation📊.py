...
st.markdown("The risk of getting diabetes tends to be lower with three or fewer pregnancies. With four to six pregnancies, the risk is moderate, but it increases significantly with more than six pregnancies.")
...
st.markdown("When glucose levels are 177 or lower, the likelihood of getting diabetes is reduced, but if they exceed this threshold, the risk of getting diabetes increases.")
...
st.markdown("When Blood pressure are 68 or lower, the likelihood of getting diabetes is reduced, but if they exceed this threshold, the risk of getting diabetes increases.")
...
st.markdown("When Skin thickness are 28 or lower, the likelihood of getting diabetes is reduced, but if they exceed this threshold, the risk of getting diabetes increases.")
...
st.markdown("When Insulin level are 100 or lower, the likelihood of getting diabetes is reduced, but if they exceed this threshold, the risk of getting diabetes increases.")
...
st.markdown("When BMI level are 30 or lower, the likelihood of getting diabetes is reduced, but if they exceed this threshold, the risk of getting diabetes increases.")
...
st.markdown("When DiabetesPedigreeFunction level are 0.5 or lower, the likelihood of getting diabetes is reduced, but if they exceed this threshold, the risk of getting diabetes increases.")
